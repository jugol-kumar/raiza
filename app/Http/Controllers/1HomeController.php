...
class HomeController extends Controller
{
    ...
    public function user_login_verify(Request $request)
    {
        ...
        $user = User::whereIn('user_type', ['customer', 'seller'])->where('email', $emailOrPhone)->orWhere('phone', $emailOrPhone)->where('verification_code', $request->code)->first();
    ...
    public function registration_store(Request $request)
    {
        ...
        if($existingUser != null){
            ...
            if(BusinessSetting::where('type', 'email_verification')->first()->value != 1){
                ...
                flash(translate('Already Registered'))->success();
            }
            else {
                event(new Registered($existingUser));
                flash(translate('Already Registered. Please verify your email.'))->success();
            }
            ...
            return $this->registered($request, $newUser)
            ?: redirect($this->redirectPath());
            } else {
