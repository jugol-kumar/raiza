                          ...
                          @if(Auth::user()->user_type == 'admin')
                              <li class="aiz-side-nav-item">
                                  <a href="{{ route('inquiry.index') }}"
                                     class="aiz-side-nav-link {{ areActiveRoutes(['inquiry.index', 'inquiry.index'])}}">
                                      <span class="aiz-side-nav-text">{{translate('Product Inquires')}}</span>
                                  </a>
                              </li>
                          @endif
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('cities.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['cities.index','cities.edit','cities.update'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Shipping City-Area')}}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
