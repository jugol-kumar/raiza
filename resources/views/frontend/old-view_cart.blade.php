                    ...
                    <div class="form-default bg-white p-4">
                        ...
                        <div class="row align-items-center pt-4">
                            ...
                            <div class="col-md-6 text-right">
                                @if(Auth::check())
                                    <a href="{{ route('checkout.shipping_info') }}" class="btn btn-styled btn-base-1 btn-danger">{{ translate('Continue to Shipping')}}</a>
                                @else
                                    <button class="btn btn-styled btn-base-1 btn-danger" onclick="showCheckoutModal()">{{ translate('Continue to Shipping')}}</button>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    @if (\App\BusinessSetting::where('type', 'guest_checkout_active')->first()->value == 1)
                        ...
                        <div class="text-center">
                            <a href="{{ route('checkout.shipping_info') }}" class="btn btn-styled btn-base-1 bg-danger">{{ translate('Guest Checkout')}}</a>
                        </div>
                    @endif
                </div>
            </div>
