...
<link type="image/x-icon" href="{{ uploaded_asset(get_setting('site_icon'))  }}" rel="shortcut icon" />
...
<link type="text/css" href="{{ static_asset('frontend/css/specturm.css')}}" rel="stylesheet" media="none" onload="if(media!='all')media='all'">
