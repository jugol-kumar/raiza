            ...
            <div class="px-2 py-4 p-md-4 bg-white shadow-sm">
                <div class="section-title-1 clearfix">
                    ...
                    <ul class="inline-links float-right">
                        <li><a class="active bg-danger">{{ translate('Top 20')}}</a></li>
                    </ul>
                </div>
                                        ...
                                        <div class="col-4">
                                            <a href="{{ route('shop.visit', $seller->user->shop->slug) }}" class="d-block product-image p-3">
                                                <img
                                                    ...
                                                    data-src="@if ($seller->user->shop->logo !== null) {{ $seller->user->shop->logo }} @else {{ static_asset('assets/img/placeholder.jpg') }} @endif"
