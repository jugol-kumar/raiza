                    ...
                    <div class="main-content">
                        ...
                        <form class="" action="{{ route('seller.profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="text-right mt-4">
                                <button type="submit" class="btn btn-styled btn-base-1 bg-danger">{{ translate('Update Profile')}}</button>
                            </div>
                        </form>
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <button class="btn btn-styled btn-base-1 bg-danger" type="submit">Update Email</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <form class="form-default" role="form" action="{{ route('addresses.store') }}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-base-1 bg-danger">{{  translate('Save') }}</button>
                    </div>
                </form>
            </div>
        </div>
