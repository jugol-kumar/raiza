                    ...
                    <div class="main-content">
                        ...
                        <form class="" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="hidden" name="seller_tags" value="true">
                                            <input type="text"
                                                   class="form-control mb-3 tagsInput"
                                                   name="tags[]"
                            ...
                            <div class="form-box mt-4 text-right">
                                <button type="submit" class="btn btn-danger btn-base-1">{{  translate('Save') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
