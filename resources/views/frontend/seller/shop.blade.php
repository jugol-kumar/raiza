                    ...
                    <div class="main-content">
                        ...
                        <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="text-right mt-4">
                                <button type="submit" class="btn btn-info btn-base-1">{{ translate('Save')}}</button>
                            </div>
                        </form>
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="text-right">
                                        <button type="button" class="btn btn-danger mb-3" onclick="add_more_slider_image()">{{  translate('Add More') }}</button>
                                    </div>
                                </div>
                            </div>
                            <div class="text-right mt-4">
