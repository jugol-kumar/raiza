                            ...
                            <div class="search-box flex-grow-1 px-4">
                                <form action="{{ route('search') }}" method="GET">
                                    <div class="d-flex position-relative">
                                        ...
                                        <button class="d-none d-lg-block bg-danger" type="submit">
                                ...
                                <div class="d-none d-lg-inline-block">
                                    <div class="nav-compare-box" id="compare">
                                        <a href="{{ route('compare') }}" class="nav-box-link">
                                            ...
                                            @if(Session::has('compare'))
                                                <span class="nav-box-number  text-white bg-danger">{{ count(Session::get('compare'))}}</span>
                                            @else
                                                <span class="nav-box-number  text-white bg-danger">0</span>
                                            @endif
                                        </a>
                                    </div>
                                </div>
                                <div class="d-none d-lg-inline-block">
                                    <div class="nav-wishlist-box" id="wishlist">
                                        <a href="{{ route('wishlists.index') }}" class="nav-box-link">
                                            ...
                                            @if(Auth::check())
                                                <span class="nav-box-number  text-white bg-danger">{{ count(Auth::user()->wishlists)}}</span>
                                            @else
                                                <span class="nav-box-number  text-white bg-danger">0</span>
                                            @endif
                                        </a>
                                ...
                                <div class="d-inline-block" data-hover="dropdown">
                                    <div class="nav-cart-box dropdown" id="cart_items">
                                        <a href="" class="nav-box-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            @if(Session::has('cart'))
                                                <span class="nav-box-number text-white bg-danger">{{ count(Session::get('cart'))}}</span>
                                            @else
                                                <span class="nav-box-number  text-white bg-danger">0</span>
                                            @endif
                                        </a>
                                                        ...
                                                        @if(count($cart = Session::get('cart')) > 0)
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="dc-image">
                                                                                <a href="{{ route('product', $product->slug) }}">
                                                                                    <img src="{{ static_asset('frontend/images/placeholder.jpg') }}" data-src="{{ uploaded_asset($product->thumbnail_img) }}" class="img-fluid lazyload" alt="{{ __($product->name) }}">
                                                                                </a>
                                                                            </div>
                                                            ...
                                                            <div class="py-2 text-center dc-btn">
                                                                <ul class="inline-links inline-links--style-3">
                                                                    <li class="px-1">
                                                                        <a href="{{ route('cart') }}" class="link link--style-1 text-capitalize bg-danger btn btn-base-1 px-3 py-1">
                                                                            <i class="la la-shopping-cart"></i> {{translate('View cart')}}
                                                                        </a>
                                                                    </li>
                                                                    @if (Auth::check())
                                                                    <li class="px-1">
                                                                        <a href="{{ route('cart') }}" class="link link--style-1 bg-danger  text-capitalize btn btn-base-1 px-3 py-1 light-text">
                                ...
                                @foreach (\App\Category::all()->take(11) as $key => $category)
                                    ...
                                    <li class="category-nav-element" data-id="{{ $category->id }}">
                                        <a href="{{ route('products.category', $category->slug) }}">
                                            <img class="cat-image lazyload" src="{{ static_asset('frontend/images/placeholder.jpg') }}" data-src="{{ uploaded_asset($category->icon) }}" width="30" alt="{{ __($category->name) }}">
