                        ...
                        <form class="form-default" data-toggle="validator" action="{{ route('checkout.store_delivery_info') }}" role="form" method="POST">
                            ...
                            <div class="card mb-3">
                                <div class="card-header bg-white py-3">
                                    <h5 class="heading-6 mb-0">{{ \App\BusinessSetting::first()->site_name }} Products</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                                    ...
                                                    <tr class="cart-item">
                                                        <td class="product-image" width="25%">
                                                            <a href="{{ route('product', \App\Product::find($id)->slug) }}" target="_blank">
                                                                <img loading="lazy"  src="{{ uploaded_asset(\App\Product::find($id)->thumbnail_img) }}">
                                                            </a>
                                                        </td>
                            ...
                            <div class="row align-items-center pt-4">
                                ...
                                <div class="col-md-6 text-right">
                                    <button type="submit" class="btn btn-styled btn-base-1 bg-danger">{{ translate('Continue to Payment')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
