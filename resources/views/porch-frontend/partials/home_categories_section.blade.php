@php $home_categories = json_decode(get_setting('categories_products')); @endphp
        ...
        <div class="container">
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                <div class="d-flex mb-3 align-items-baseline border-bottom">
                    ...
                    <a href="{{ route('products.category', $category->slug) }}" class="ml-auto mr-0 btn bg-danger btn-sm shadow-md">{{ translate('View More') }}</a>
                </div>
